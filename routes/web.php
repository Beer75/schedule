...
Route::get('/export', [ScheduleController::class, 'export'])->name('schedule.export')->middleware(['auth', 'role:scheduler']);
Route::post('/export', [ScheduleController::class, 'make_export'])->name('schedule.make_export')->middleware(['auth', 'role:scheduler']);
